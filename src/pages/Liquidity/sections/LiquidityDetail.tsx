...
const LiquidityDetail = () => {
  return (
    <div className="bf-card border-[3px] border-line p-6 h-min w-[327px] md:w-[703px] xl:w-[373px] rounded-lg">
      ...
      <h3 className="text-header font-input">Liquidity Details</h3>
      ...
      <div className="mt-4 flex flex-col gap-3">
        ...
        <div className="flex justify-between">
          <div className="flex items-center gap-[5.5px]">
            <h5 className="text-body font-capital">Max amount</h5>
            <INFO className="w-4 h-4" />
          </div>
          <h4 className="text-header font-capital">--- </h4>
        </div>

        <div className="flex justify-between">
          <div className="flex items-center gap-[5.5px]">
            <h5 className="text-body font-capital">EGLD Per EBONE</h5>
            <INFO className="w-4 h-4" />
          </div>
          <h4 className="text-body font-capital">---</h4>
        </div>

        <div className="flex justify-between">
          <div className="flex items-center gap-[5.5px]">
            <h5 className="text-body font-capital">LP Supply</h5>
            <INFO className="w-4 h-4" />
          </div>
          <h4 className="text-header font-capital">--</h4>
        </div>
